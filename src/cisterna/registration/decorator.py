"""Public decorator for the cisterna registration subsystem.
...
A benign marker attribute ``__cisterna_tool__ = True`` is set on *fn* before
...
from cisterna.registration.registry import register
...
def tool(
    ...
    *,
    ...
    def _register_and_return(f: Callable[..., Any]) -> Callable[..., Any]:
        ...
        f.__cisterna_tool__ = True  # type: ignore[attr-defined]
        return f
