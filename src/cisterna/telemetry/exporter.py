...
class JsonlExporter(ExporterBase):
    ...
    def __init__(
        ...
        self._logger = logging.getLogger(f"cisterna.exporter.{id(self)}")
    ...
    def export(self, record: Record) -> None:
        ...
        try:
            ...
            print(f"[cisterna] JsonlExporter.export() failed: {e}", file=sys.stderr)
            with self._lock:
                self._drop_count += 1
    ...
    def flush(self) -> None:
        ...
        try:
            ...
            print(f"[cisterna] JsonlExporter.flush() failed: {e}", file=sys.stderr)
    ...
    def close(self) -> None:
        ...
        try:
            ...
            print(f"[cisterna] JsonlExporter.close() failed: {e}", file=sys.stderr)
